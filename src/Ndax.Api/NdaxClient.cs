...
namespace Ndax.Api
{
    public partial class NdaxClient : INdaxClient, IDisposable
    {
        ...
        /// <summary>
        /// Sends a public GET request to the NDAX API as an asynchronous operation.
        /// </summary>
        ...
        /// <remarks>The <paramref name="requestUrl"/> is relative to https://ndax.io/api/. </remarks>
        ...
        /// <exception cref="QuadrigaException">There was a problem with the NDAX API call.</exception>
        ...
        /// <summary>
        /// Releases the unmanaged resources and disposes of the managed resources used by the underlying <c>HttpClient</c>.
        /// </summary>
